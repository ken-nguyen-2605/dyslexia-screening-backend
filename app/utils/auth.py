...
from app.env import ACCESS_TOKEN_EXPIRE_MINUTES, ALGORITHM, SECRET_KEY
...
def get_current_account(
    request: Request,
    auth_header: HTTPAuthorizationCredentials = Depends(bearer_security),
...
# RBAC dependencies
def require_role(required_roles: list[AccountRole]):
